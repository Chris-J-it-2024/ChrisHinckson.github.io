...
class ExpenseTracker:
    ...
    db_connection=mysql.connector.connect(
        host='localhost',
        database='expense_tracker',    # THIS IS EITHER THE CORRECT NAME OR USE " Expense_8 "
        user='krys_at_Just_I_T',
        password='alnESS625zero?*F'
    )    
...
#   * Required environment variables are missing
    ...
    # - pool_size: Number of connections to maintain in pool
        ...
        """
    #RConnection = mysql.connector.connect()
        #RETURNS:
